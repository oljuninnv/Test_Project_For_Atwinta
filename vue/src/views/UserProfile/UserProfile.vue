    ...
    <section v-if="isAuthenticated" class="p-10">
        ...
        <div
            ...
            <div class="mt-16 flex flex-col items-center">
                ...
                <p v-if="user.user.worker_id" class="text-lightSecondary text-base font-normal text-center">{{
                    user.user.position }}</p>
            </div>
            <div class="mt-6 mb-3 flex flex-col gap-2">
                ...
                <router-link :to="{ name: 'UserProfileEdit', params: { id: user.user.id } }"
                    class="bg-bluePrimary font-bold py-2 px-4 rounded hover:bg-red-500 hover:text-white w-full text-center block">
