  ...
  <div v-if="isAdmin" class="flex flex-wrap bg-gray-100 w-full h-screen">
    <div class="bg-white rounded p-3 shadow-lg w-full md:w-3/12 lg:w-2/12">
      ...
      <ul class="space-y-2 text-sm">
        ...
        <li>
          <a href="#" @click.prevent="showTable('workers')" class="flex items-center space-x-3 text-gray-700 p-2 rounded-md font-medium hover:bg-gray-200 focus:bg-gray-200 focus:shadow-outline">
            <span>Сотрудники</span>
          </a>
        </li>
        <li>
          <a href="#" @click.prevent="showTable('departments')" class="flex items-center space-x-3 text-gray-700 p-2 rounded-md font-medium hover:bg-gray-200 focus:bg-gray-200 focus:shadow-outline">
            <span>Отделы</span>
          </a>
        </li>
        <li>
